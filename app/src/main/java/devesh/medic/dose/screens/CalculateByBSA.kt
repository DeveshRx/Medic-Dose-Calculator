...
fun CalculateByBSA(
    ...
    childHeight: MutableState<String>,
    ...
    var text_height by remember { childHeight }
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                supportingText = {
                    Text(
                        modifier = Modifier.fillMaxWidth(),
                        text = "Child's Height in Centimeters (cm)",
                    )
                },
                keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number)
            ...
            RadioButtonGroupBSA(onFormulaChange = {
                onFormulaChange(it)
...
@Composable
fun RadioButtonGroupBSA(onFormulaChange: (CalcFormulas) -> Unit) {
    val selectedValue = remember { mutableStateOf("Mosteller formula") }
...
@Composable
fun CalculateByBSACompose_Preview() {

    CalculateByBSA(
        adultDose = mutableStateOf("ds"),
        weightInput = mutableStateOf("d"),
        childHeight = mutableStateOf("150"),
        onFormulaChange = {
...
@Composable
fun BottomSheetResultsBSAPREVIEW() {
    BottomSheetResultsBSA(
        result = "34",
        childWeight = 5,
        adultDose = 50.3,
